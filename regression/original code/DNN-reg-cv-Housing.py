...
np.savez('D:\\Li-Jyung-Ying\\Keras-Objects\\tree-like-nn\\Regression\\DNN_Housing_cv_result', **result)

# Load the result of NPZ file

result = np.load('D:\\Li-Jyung-Ying\\Keras-Objects\\tree-like-nn\\Regression\\DNN_Housing_cv_result.npz')
...
plot_model(model, to_file = 'DNN_housing_model0.png')
plot_model(model, show_shapes = True, to_file = 'DNN_housing_model1.png')

#----------------------------------------
# Save the model to HDF5 file

file_path_hdf5 = 'D:\\Li-Jyung-Ying\\Keras-Objects\\tree-like-nn\\Regression\\DNN_Housing_cv'
