...
plot_model(model, to_file = 'DNN_diabetes_model0.png')
plot_model(model, show_shapes = True, to_file = 'DNN_diabetes_model1.png')

#----------------------------------------
# Save the result to NPZ file

np.savez('D:\\Li-Chun-Ying\\Keras-Objects\\tree-like-nn\\Classification\\DNN_cla_Diabetes_cv_result', **result)

# Load the result of NPZ file

result = np.load('D:\\Li-Chun-Ying\\Keras-Objects\\tree-like-nn\\Classification\\DNN_cla_Diabetes_cv_result.npz')
...
file_path_hdf5 = 'D:\\Li-Chun-Ying\\Keras-Objects\\tree-like-nn\\Classification\\DNN_cla_Diabetes_cv.h5'
