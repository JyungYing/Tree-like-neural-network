#=======================================
## Tree-like neural network - Glass-Identification-Data
#=======================================

###################

# Decision tree: R codes: Glass-Identification-Data Compressive Strength dataset.

#----------------------------------------
# Load the Glass-Identification-Data dataset.

data_original = read.table("D:/Li-Chun-Ying/Data-Sets/classification/Glass-Identification-Data.txt", header = FALSE, sep = ',')
...
np.savez('D:\\Li-Chun-Ying\\Keras-Objects\\tree-like-nn\\Classification\\Tree_like_nn_cla_cv_result(Glass-Identification)', **result)

# Load the result of NPZ file

result = np.load('D:\\Li-Chun-Ying\\Keras-Objects\\tree-like-nn\\Classification\\Tree_like_nn_cla_cv_result(Glass-Identification).npz')
...
plot_model(model, to_file = 'TLNN_glass identification_model0.png')
plot_model(model, show_shapes = True, to_file = 'TLNN_glass identification_model1.png')

#----------------------------------------
# Save the model to H5 file

file_path_hdf5 = 'D:\\Li-Chun-Ying\\Keras-Objects\\tree-like-nn\\Classification\\Tree_like_nn_cla_cv(Glass-Identification).h5'
